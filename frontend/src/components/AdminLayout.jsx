              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  `w-full flex items-center gap-4 px-4 py-3 rounded-xl transition-all duration-300 group ${
                    isActive
                      ? 'bg-turf-alert/10 text-white border border-turf-alert/30'
                      : 'hover:bg-turf-alert/10 text-white/70 hover:text-white'
                  }`
                }
              >
                {({ isActive }) => (
                  <>
                    <item.icon size={20} className={`${isActive ? 'text-turf-alert' : 'text-white/40 group-hover:text-turf-alert'} transition-colors`} />
