    ...
    <div className="h-screen flex bg-black text-white">
      ...
      <main className="flex-1 p-10 bg-black text-white">
        ...
        <form onSubmit={handleSubmit} className="mt-4 bg-[#1a1a1a] p-6 rounded-lg shadow-lg">
          <div className="mb-4">
            <label htmlFor="eventName" className="block text-sm font-medium text-green-400 mb-1">Event Name</label>
            <input
              type="text"
              id="eventName"
              name="eventName"
              ...
              className="mt-1 p-2 w-full border border-gray-600 bg-black rounded text-white focus:outline-none focus:ring-2 focus:ring-green-400"
              required
            />
          </div>
          <div className="mb-4">
            <label htmlFor="eventDate" className="block text-sm font-medium text-green-400 mb-1">Event Date</label>
            <input
              type="date"
              id="eventDate"
              name="eventDate"
          ...
          <div className="mb-4">
            <label htmlFor="eventTime" className="block text-sm font-medium text-green-400 mb-1">Event Time</label>
            <input
              type="time"
              id="eventTime"
              name="eventTime"
          ...
          <div className="mb-4">
            <label htmlFor="eventDescription" className="block text-sm font-medium text-green-400 mb-1">Event Description</label>
            <textarea
              id="eventDescription"
          ...
          <button
            type="submit"
            className="mt-4 bg-blue-600 hover:bg-blue-700 transition text-white py-2 px-4 rounded"
          >
            Submit Event
          </button>
        </form>
